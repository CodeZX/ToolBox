...
#import "CLStaticTextCell.h"
#import "SUTableView.h"

@interface CLZoomPickerView () <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
@implementation CLZoomPickerView
...
- (void)layoutSubviews
{
    ...
    {
        self.tableView = [[SUTableView alloc] initWithFrame:frame];
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 创建cell
    CLStaticTextCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil)
    {
        cell = [[CLStaticTextCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
